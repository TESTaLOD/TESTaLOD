 $(document).ready(function(){
        ...
        $('input[type=radio][name=input-path]').change(function() {
            switch ($(this).val()) {
                case 'url':
                        $("#holder").html("")
                        $("#holder").html('<input type="text" class="form-control" id="urlinput" name="url" value="https://github.com/TESTaLOD/TESTaLOD/tree/master/testcase/CQ" required> <small id="emailHelp" class="form-text text-muted">Load owl files from a Github folder (github folder url required)</small>')
